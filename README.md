...
- Media: mpv, Spotify, Calibre, YACReader, drtv-dl (DRTV downloads with Jellyfin naming, NFO metadata and artwork), standardebooks-dl (syncs a Calibre-style ebook library from standardebooks.org, with covers)
